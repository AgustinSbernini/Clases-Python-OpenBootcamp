    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(help_text='De que se trata el libro?', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Inserte el nombre del genero', max_length=64)),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
        ...
        migrations.AddField(
            model_name='book',
            name='gender',
            field=models.ManyToManyField(to='catalog.gender'),
        ),
    ]
